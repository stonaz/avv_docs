...
def manage_index(request):
    ...
    return render(request, 'dynamic-docs/manage_index.html', context) 
...
def host_add(request):
    ...
    return render(request, 'dynamic-docs/add_host.html', context)
...
def service_add(request):
    ...
    return render(request, 'dynamic-docs/add_service.html', context)
...
def host_update(request,id):
    ...
    #print message
    return render(request, 'dynamic-docs/update_host.html', context)
...
def service_update(request,id):
    ...
    return render(request, 'dynamic-docs/update_service.html', context)
...
def host_delete(request,id):
    ...
    return render(request, 'dynamic-docs/delete_host.html', context)
...
def service_delete(request,id):
    ...
    context = {'services_list': services_list,'host_list': host_list,'message':message,'menu':menu_id}
    return render(request, 'dynamic-docs/delete_service.html', context)
