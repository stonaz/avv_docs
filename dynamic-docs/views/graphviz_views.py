...
def index(request):
    ...
    return render(request, 'dynamic-docs/index.html', context)
...
def hosts_index(request):
    ...
    return render(request, 'dynamic-docs/hosts_index.html', context)
...
def servizi_index(request):
    ...
    return render(request, 'dynamic-docs/services_index.html', context)
...
def host_detail(request,id):
    ...
    return render(request, 'dynamic-docs/show_host.html', context)
...
def service_detail(request,id):
    ...
    filename = 'dynamic-docs/static/dynamic-docs/graphics/' + node + '_deps_down.png'
    context_filename = 'dynamic-docs/graphics/' + node + '_deps_down.png?dummy=' + ts
    
    filename2 = 'dynamic-docs/static/dynamic-docs/graphics/' + node + '_deps_up.png'
    context_filename2 = 'dynamic-docs/graphics/' + node + '_deps_up.png?dummy=' + ts

    if settings.DEBUG == False :
        filename = settings.STATIC_ROOT + 'dynamic-docs/graphics/'+ node + '_deps_down.png'
        filename2 = settings.STATIC_ROOT + 'dynamic-docs/graphics/'+ node + '_deps_up.png'
    ...
    return render(request, 'dynamic-docs/show_service.html', context)
